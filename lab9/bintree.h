...
namespace coen79_lab9
{
    ...
    // Library facilities used: cstdlib
    {
        if (node_ptr != NULL)
        {
            ...
            f(node_ptr->data());            //left subtree has been processed, now f to root
    ...
    // Library facilities used: cstdlib
    {
        if(node_ptr != NULL) {
            ...
            f(node_ptr->data());                //only process root after both subtrees have been processed
        }
    }
    ...
    {   
        if(node_ptr != NULL) {
            f(node_ptr->data());                //process root first before subtrees
    ...
    // Library facilities used: cstdlib
    {
        ...
        if (root_ptr != NULL)
        {
            child = root_ptr->left( );                  //proceed through left subtree and clear
            tree_clear( child );
            child = root_ptr->right();                  //proceed through right subtree and clear
            tree_clear(child);
            delete root_ptr;                            //return mem to heap and set to NULL
            root_ptr = NULL;
        }
    }
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            l_ptr = tree_copy(root_ptr->left());            //l_ptr points to left subtree
            r_ptr = tree_copy(root_ptr->right());           //r_ptr points to right subtree

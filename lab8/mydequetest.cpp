...
int main(int argc, const char * argv[]) {
    ...
    //ensure tht the deques are empty after being copied/assigned
    ...
    //makes two clones of testdeque1 via copy constructor and then assignment operator
    //output for all three should match
    //outputs each deque by using the deque_iterator

...
void test_mean(sequence& s);

void test_summation(sequence& s);

void test_standardDeviation(sequence& s);
...
int main( )
{
    ...
    cout << "First: testing += operator" << endl;

    sequence opTest1;
    opTest1.attach(1); opTest1.attach(2); opTest1.attach(3);
    show_sequence(opTest1);
    cout << endl << endl;
    sequence opTest2;
    opTest2.attach(4); opTest2.attach(5); opTest2.attach(6);
    show_sequence(opTest2);
    cout << endl << endl;
    cout << "added together using +=" << endl;
    opTest1 += opTest2;
    show_sequence(opTest1); 

    cout << endl << "Now testing + operator: \n\n";
    sequence opTest3;
    opTest3 = opTest1 + opTest2;
    show_sequence(opTest3);
    cout << endl;
    ...
    do
    {
        ...
        switch (choice)
        {
            ...
            case 'R': test.remove_current( );
                      ...
                      break;
            case 'M': test_mean(test);
                      break;  
            case 'U': test_summation(test);
                      break;
            case 'B': test.attach_back(get_number());
                      break;
            case 'F': test.insert_front(get_number());
                      break;
            case 'D': test_standardDeviation(test);
                      break;
...
// Library facilities used: iostream.h
{
    ...
    cout << " M   Compute mean of this sequence" << endl;
    cout << " U   Compute sum of this sequence" << endl;
    cout << " B   Attach to the back of this sequence" << endl;
    cout << " F   Attach to the front of this sequence" << endl;
    cout << " D   Compute the standard deviation of this sequence" << endl;
...
void test_summation(sequence& s) {
    double sum = summation(s);
    cout << "Summation: " << sum << endl;
}

void test_standardDeviation(sequence& s) {
    double sd = s.standardDeviation();
